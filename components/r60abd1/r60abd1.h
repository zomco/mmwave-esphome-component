...
namespace esphome
{
  namespace r60abd1
  {
    ...
    protected:
      ...
      sensor::Sensor *heart_rate_wave_0_sensor_{nullptr};
      sensor::Sensor *heart_rate_wave_1_sensor_{nullptr};
      sensor::Sensor *heart_rate_wave_2_sensor_{nullptr};
      sensor::Sensor *heart_rate_wave_3_sensor_{nullptr};
      sensor::Sensor *heart_rate_wave_4_sensor_{nullptr};

      text_sensor::TextSensor *respiration_info_sensor_{nullptr};
      sensor::Sensor *respiration_rate_sensor_{nullptr};
      sensor::Sensor *respiration_rate_wave_0_sensor_{nullptr};
      sensor::Sensor *respiration_rate_wave_1_sensor_{nullptr};
      sensor::Sensor *respiration_rate_wave_2_sensor_{nullptr};
      sensor::Sensor *respiration_rate_wave_3_sensor_{nullptr};
      sensor::Sensor *respiration_rate_wave_4_sensor_{nullptr};
      ...
      std::vector<R60ABD1Listener *> listeners_;
    };
